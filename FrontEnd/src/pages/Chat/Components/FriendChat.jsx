                    ...
                    <div className="flex items-start gap-2.5">
                        ...
                        <div className="flex flex-col w-full max-w-[320px] leading-1.5 p-4 border-gray-200 bg-gray-100 rounded-e-xl rounded-es-xl dark:bg-gray-700">
                            <div className="flex items-center space-x-2 rtl:space-x-reverse">
                                <span className="text-sm font-semibold text-gray-900 dark:text-white">Ahmed Magdy</span>
                        ...
                        <div className="flex flex-col gap-2.5 w-full max-w-[320px] leading-1.5 p-4 border-gray-200 bg-gray-100 rounded-e-xl rounded-es-xl dark:bg-gray-700">
                            ...
                            <div className="flex items-center space-x-2 rtl:space-x-reverse">
                                ...
                                <svg aria-hidden="true" className="w-[145px] md:w-[185px] md:h-[40px]" viewBox="0 0 185 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <rect x="98" width="3" height="40" rx="1.5" fill="#E5E7EB" className="dark:fill-gray-500" />
                                    <rect x="105" y="0.5" width="3" height="39" rx="1.5" fill="#E5E7EB" className="dark:fill-gray-500" />
                                    <rect x="112" y="3" width="3" height="34" rx="1.5" fill="#E5E7EB" className="dark:fill-gray-500" />
                                    <rect x="119" y="3" width="3" height="34" rx="1.5" fill="#E5E7EB" className="dark:fill-gray-500" />
                                    <rect x="126" y="5.5" width="3" height="29" rx="1.5" fill="#E5E7EB" className="dark:fill-gray-500" />
                                    <rect x="133" y="10" width="3" height="20" rx="1.5" fill="#E5E7EB" className="dark:fill-gray-500" />
                                    <rect x="140" y="13.5" width="3" height="13" rx="1.5" fill="#E5E7EB" className="dark:fill-gray-500" />
                                    <rect x="147" y="16" width="3" height="8" rx="1.5" fill="#E5E7EB" className="dark:fill-gray-500" />
                                    <rect x="154" y="15.5" width="3" height="9" rx="1.5" fill="#E5E7EB" className="dark:fill-gray-500" />
                                    <rect x="161" y="10" width="3" height="20" rx="1.5" fill="#E5E7EB" className="dark:fill-gray-500" />
                                    <rect x="168" y="6.5" width="3" height="27" rx="1.5" fill="#E5E7EB" className="dark:fill-gray-500" />
                                    <rect x="175" y="3" width="3" height="34" rx="1.5" fill="#E5E7EB" className="dark:fill-gray-500" />
                                </svg>
                                <span className="text-sm font-normal text-gray-500 dark:text-gray-400">0:12</span>
                            </div>
                            <span className="text-sm font-normal text-gray-500 dark:text-gray-400">Delivered</span>
                        </div>
                    </div>
                ...
                return (
                    <div className="flex items-start gap-2.5">
                        ...
                        <div className="flex flex-col w-full max-w-[320px] leading-1.5 p-4 border-gray-200 bg-gray-100 rounded-e-xl rounded-es-xl dark:bg-gray-700">
                            ...
                            <div className="w-full max-w-[320px] h-48 bg-gray-300 rounded-lg my-3 dark:bg-gray-600"></div>
                            <span className="text-sm font-normal text-gray-500 dark:text-gray-400">Delivered</span>
                        </div>
