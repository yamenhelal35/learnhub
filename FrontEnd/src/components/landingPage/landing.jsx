...
function Landing() {
  return (
    ...
    <div className="flex flex-col bg-white dark:bg-gray-900">
      ...
      <main className="flex-grow mt-8 ml-64 flex flex-col justify-center items-center">
          ...
          <section class="bg-white dark:bg-gray-900">
            <div class="py-6 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12">
              <a href="#" class="inline-flex justify-between items-center py-1 px-1 pr-4 mb-7 text-sm text-gray-700 bg-gray-100 rounded-full dark:bg-gray-800 dark:text-white hover:bg-gray-200 dark:hover:bg-gray-700" role="alert">
                <span class="text-xs bg-primary-600 rounded-full text-white px-4 py-1.5 mr-3">New</span> <span class="text-sm font-medium">LearnHub Courses is out! See what's new</span>
                <svg class="ml-2 w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clip-rule="evenodd"></path></svg>
              </a>
              <h1 class="mb-4 text-4xl font-extrabold tracking-tight leading-none text-gray-900 md:text-5xl lg:text-6xl dark:text-white">Empowering minds, transforming futures</h1>
              <p class="mb-8 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 xl:px-48 dark:text-gray-400">Empower your learning journey with LearnHub – Seamlessly manage your assignments, exams, and study schedules all in one place. Connect with expert teachers who are dedicated to guiding you towards success.</p>
        ...
        <section className="Service">
          <section class="bg-white dark:bg-gray-900 flex ">
            <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-0 lg:px-6 ">
              <div class="max-w-screen-md mb-8 lg:mb-16 ">
                <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white ">Designed for anykind of eductaion needed</h2>
                <p class="text-gray-500 sm:text-xl dark:text-gray-400">At LearnHub, we believe in making education accessible and enjoyable. Through innovative learning solutions and dedicated support, we empower learners worldwide to realize their dreams and make a positive impact on their communities.</p>
              </div>
              <div class="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
                ...
                <div>
                  ...
                  <h3 class="mb-2 text-xl font-bold dark:text-white">Planing</h3>
                  <p class="text-gray-500 dark:text-gray-400">Plan it, create it, launch it. Collaborate seamlessly with all  the organization and hit your Studying goals every month with our plans.</p>
                </div>
                {/* =========================================== */}
                <div>
                  <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
                  ...
                  <p class="text-gray-500 dark:text-gray-400">Protect your Community, Study Matarials and stay compliant with our structured workflows and custom permissions made for you.</p>
                </div>
                 {/* =========================================== */}
                <div>
                  <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
                  ...
                  <h3 class="mb-2 text-xl font-bold dark:text-white">Study Automation</h3>
                  <p class="text-gray-500 dark:text-gray-400">Auto-assign tasks, send messages, and much more. Now power up with hundreds of new Features to help you get started.</p>
                </div>
                ...
                <div>
                  ...
                  <p class="text-gray-500 dark:text-gray-400">Keep your Study lights on with customizable, iterative, and structured workflows built for all efficient teams and individual.</p>
                </div>
              </div>
            </div>
          </section>
          ...
          <section class="bg-white dark:bg-gray-900">
            <div class="gap-16 items-center py-8 px-4 mx-auto max-w-screen-xl lg:grid lg:grid-cols-2 lg:py-16 lg:px-6">
              <div class="font-light text-gray-500 sm:text-lg dark:text-gray-400">
                ...
                <p class="mb-4">We are Students, Teachers and Mentors. Innovators and problem solvers. Small enough to be simple and quick, but big enough to deliver the scope you want at the pace you need. Small enough to be simple and quick, but big enough to deliver the scope you want at the pace you need.</p>
